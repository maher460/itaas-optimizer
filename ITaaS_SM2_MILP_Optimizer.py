from src.service_model_2_milp_optimizer import *
...
sm2_functions_to_test = [sm2_milp_max_sites]
...
for num_apps in apps_collection.keys():
    for list_num in range(len(apps_collection[num_apps])):
        ...
        fname = "./data/benchmark_results/service_model_2_milp/res_app_list_"+str(num_apps)+"_"+str(list_num)+".csv"
