...
def run():
    ...
    plt.savefig('evaluation_results/SM1_VerifiedPlacements_CDF.png', bbox_inches='tight')
    plt.close()

    plt.savefig('evaluation_results/SM1_ExecutionTimes_CDF.png', bbox_inches='tight')
    plt.close()

    plt.savefig('evaluation_results/SM1_Replicas_CDF.png', bbox_inches='tight')
    plt.close()

    plt.savefig('evaluation_results/SM1_Apps_CDF.png', bbox_inches='tight')
    plt.close()
