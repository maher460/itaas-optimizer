...
def run():
    ...
    plt.savefig('evaluation_results/SM2_VerifiedPlacements_CDF.png', bbox_inches='tight')
    plt.close()

    plt.savefig('evaluation_results/SM2_ExecutionTimes_CDF.png', bbox_inches='tight')
    plt.close()

    plt.savefig('evaluation_results/SM2_Replicas_CDF.png', bbox_inches='tight')
    plt.close()

    plt.savefig('evaluation_results/SM2_Apps_CDF.png', bbox_inches='tight')
    plt.close()
