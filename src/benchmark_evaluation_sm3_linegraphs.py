...
def run():
    ...
    plt.savefig('evaluation_results/SM3_VerifiedPlacements_Avg_Line.png', bbox_inches='tight')
    plt.close()

    plt.savefig('evaluation_results/SM3_ExecutionTimes_Avg_Line.png', bbox_inches='tight')
    plt.close()

    plt.savefig('evaluation_results/SM3_Replicas_Avg_Line.png', bbox_inches='tight')
    plt.close()

    plt.savefig('evaluation_results/SM3_Apps_Avg_Line.png', bbox_inches='tight')
    plt.close()
