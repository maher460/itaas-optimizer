...
def run():
    ...
    fig_machines = plt.figure(figsize=(7, 5), layout="constrained")
    #fig_machines.suptitle("Service Model 3: Average Number of Machines (lower is better)")
    axs_machines = fig_machines.subplots(2, 1, sharex=True, sharey=True)

    fig_cost = plt.figure(figsize=(7, 5), layout="constrained")
    #fig_cost.suptitle("Service Model 3: Average Cost (lower is better)")
    axs_cost = fig_cost.subplots(2, 1, sharex=True, sharey=True)

    fig_cost_per_app = plt.figure(figsize=(7, 5), layout="constrained")
    #fig_cost_per_app.suptitle("Service Model 3: Average Cost per App (lower is better)")
    axs_cost_per_app = fig_cost_per_app.subplots(2, 1, sharex=True, sharey=True)
    ...
    plt.savefig('evaluation_results/SM3_VerifiedPlacements_Avg_Bar.png', bbox_inches='tight')
    plt.close()

    plt.savefig('evaluation_results/SM3_ExecutionTimes_Avg_Bar.png', bbox_inches='tight')
    plt.close()

    plt.savefig('evaluation_results/SM3_CostPerApp_Avg_Bar.png', bbox_inches='tight')
    plt.close()

    plt.savefig('evaluation_results/SM3_Cost_Avg_Bar.png', bbox_inches='tight')
    plt.close()

    plt.savefig('evaluation_results/SM3_Machines_Avg_Bar.png', bbox_inches='tight')
    plt.close()

    plt.savefig('evaluation_results/SM3_Replicas_Avg_Bar.png', bbox_inches='tight')
    plt.close()

    plt.savefig('evaluation_results/SM3_Apps_Avg_Bar.png', bbox_inches='tight')
    plt.close()
