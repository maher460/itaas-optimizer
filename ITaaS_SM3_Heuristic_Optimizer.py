...
results_dir = "./data/benchmark_results/service_model_2_proactive_recovery_heuristic"
...
for num_apps in apps_collection.keys():
    for list_num in range(len(apps_collection[num_apps])):
        ...
        for func in sm2_functions_to_test:
            ...
            (placements, pr_groups, sites_machines) = func(app_list, resources)

            end_time = time.time()

            execution_time = (end_time - start_time) * 1000

            quality = calc_quality_service_model_2(app_list, placements, resources, True)
